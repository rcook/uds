...
def test_coverage_command_no_tool_found(tmp_workspace: Workspace, tmp_package: Path) -> None:  # pyright: ignore[reportUnusedParameter]
...
def test_test_command_no_tool_found(tmp_workspace: Workspace, tmp_package: Path) -> None:  # pyright: ignore[reportUnusedParameter]
...
def test_type_check_command_no_tool_found(tmp_workspace: Workspace, tmp_package: Path) -> None:  # pyright: ignore[reportUnusedParameter]
